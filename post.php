            ...
            <div class="col-md-8 card">
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        ...
                        <a href="whatsapp://send?text=Confira essa deliciosa receita de Escondidinho de Carne Seca no Chef Em Casa" class="btn btn-success" target="_blank" rel="noopener">
                            <i class="fab fa-whatsapp"></i> WhatsApp
                        </a>
                        <a href="https://www.facebook.com/sharer/sharer.php?u=[URL]" class="btn btn-primary" target="_blank" rel="noopener">
                            <i class="fab fa-facebook"></i> Facebook
                        </a>
                        <a href="https://twitter.com/intent/tweet?url=[URL]&text=Confira essa deliciosa receita de Escondidinho de Carne Seca no Chef Em Casa" class="btn btn-info" target="_blank" rel="noopener">
                            ...
                            <div class="media mt-4">
                                ...
                                <?php if (isset($_SESSION['user_id'])) { ?>
                                    <?php if ($_SESSION['user_id'] == $comment['user_id']) { ?>
                                        <a href="requests/request_delete_comment.php?comment_id=<?php echo
                                                                                                $comment['id']; ?>" class="btn btn-sm btn-danger ml-2">
                                            <i class="fas fa-trash"></i>
                                        </a>
                                    <?php } ?>
                                    <a id="like" href="request/request_like_comment.php?comment_id=<?php echo
                                                                                                    $comment['id']; ?>&post_id=<?php echo $post_id; ?>" class="btn btn-sm btn-sucess ml-2">
                    ...
                    <div class="mt-4">
                        ...
                        <?php } else { ?>
                            <form action="requests/request_create_comment.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="content" name="content" rows="3" placeholder="Digite seu comentário" required></textarea>
                                </div>
